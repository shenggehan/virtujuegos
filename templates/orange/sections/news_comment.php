...
<?php echo '
<div class="news_comment_avatar">
	<img src="'.$comment['avatar_url'].'" width="50" height="50" alt="Avatar" />
</div>
<div class="news_comment_content">
	<div class="news_comment_username">
		<a href="'.$comment['user_url'].'">'.$comment['username'].'</a> ('.$comment['user_points'].') - '.$comment['date'].' '.$comment['report_button'].' <span class="lighturl">'.$comment['delete'].'</span>
	</div>

	<div class="news_thecomment">
		'.$comment['content'].'
	</div>
</div>
<br style="clear:both" />'; ?>
...
$template['search_game'] = 'sections/search_game.php';
...
// Highscore image
$template['highscore_image'] = '<img src="'.$setting['site_url'].'/images/trophy_smaller.png" alt="trophy" />';
...
$template['random_game_limit'] = 3; // Number of games to show in the random games section
$template['games_per_page'] = 20; // Number of games to show per page in categories
$template['comments_per_page'] = 15; // Number of comments to show per page on game pages (5.5)

$template['category_game_chars'] = 25; // The character limit for game names in categories
$template['category_game_desc_chars'] = 70; // The character limit for game descriptions in categories
$template['homepage_game_chars'] = 25; // The character limit for game names on the homepage
$template['homepage_game_desc_chars'] = 70; // The character limit for game descriptions on the homepage
$template['featured_game_chars'] = 25; // The character limit for featured game names (5.5)
$template['featured_game_desc_chars'] = 60; // The character limit for featured game descriptions (5.5)
$template['random_game_chars'] = 25; // The character limit for the random game names
$template['random_game_desc_chars'] = 120; // The character limit for the random game descriptions
$template['module_max_chars'] = 22; // The character limit modules (game names, news)

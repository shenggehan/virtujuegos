...
$template['random_game_limit'] = 7; // Number of games to show in the random games section
...
$template['category_game_desc_chars'] = 65; // The character limit for game descriptions in categories
$template['homepage_game_chars'] = 25; // The character limit for game names on the homepage
$template['homepage_game_desc_chars'] = 65; // The character limit for game descriptions on the homepage

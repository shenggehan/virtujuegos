...
<div class="form_element_container">
   ...
   <div class="form_element">
      <a href="#" onclick="file_selector(3, 0, 0);return false" id="enter_url_link0" class="bold">Enter URL</a> | <a href="#" onclick="file_selector(2, 0, 0);return false" id="select_link0">Select from games folder</a> | <a href="#" onclick="file_selector(1, 0, 0);return false" id="upload_link0">Upload file</a> | <a href="#" onclick="file_selector(4, 0, 0);return false" id="grab_link0">Grab file</a> | <a href="#" onclick="file_selector(5, 0, 0);return false" id="file_html_code0">HTML</a>

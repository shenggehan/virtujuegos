...
editstyle = '../admin/js/wyzzstyles/editarea.css';

// Do we want to try to clean the code to emulate xhtml? 1=Yes, 0=No
xhtml_out = 0;

// Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="../admin/js/wyzzstyles/style.css">\n');
...
function make_wyzz(textareaID) {
  ...
  if(toolbarCount == 2) {
    ...
    for (btn in buttonName) {
      ...
      if(buttonName[btn] == "separator") {
        ...
        toolbar += '<td style="width: 22px;"><img src="../admin/js/wyzzicons/' +buttonName[btn]+ '.gif" border=0 unselectable="on" title="' +buttonName[btn]+ '" id="' +buttonName[btn]+ '" class="wzbutton" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button\'){className=\'buttonOver\'};" onmouseout="if(className==\'buttonOver\'){className=\'button\'};" unselectable="on" width="20" height="20"></td>';
        }
    }
  ...
  var toolbar2 =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:' + toolbarWidth + 'px;"><tr>';
  ...
  for (btn in buttonName2) {
    ...
    if(buttonName2[btn] == "separator") {
      ...
      toolbar2 += '<td style="width: 22px;"><img src="../admin/js/wyzzicons/' +buttonName2[btn]+ '.gif" border=0 unselectable="on" title="' +buttonName2[btn]+ '" id="' +buttonName2[btn]+ '" class="wzbutton" onClick="formatText(this.id,\'' + n + '\');" onmouseover="if(className==\'button\'){className=\'buttonOver\'};" onmouseout="if(className==\'buttonOver\'){className=\'wzbutton\'};" unselectable="on" width="20" height="20"></td>';
      }
  }
  toolbar2 += '<td>&nbsp;</td></tr>';
...
var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wyzzW + 'px; height:' + wyzzH + 'px;border: 1px solid #cccccc;"><tr><td valign="top">\n'

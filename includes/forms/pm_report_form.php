...
<div class="comment_report_text"><?php echo PM_REPORT_TITLE; ?></div>
...
<form action="" method="get" onsubmit="return false;">
    ...
    <br />
      ...
      <input type="submit" name="Submit" id="report_submit" value="<?php echo GAME_SUBMIT_REPORT;?>" onclick="SendReport(<?php echo $id.",'".$setting['site_url'];?>', 6)" />
